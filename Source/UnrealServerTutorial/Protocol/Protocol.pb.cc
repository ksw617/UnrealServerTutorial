...
const uint32_t TableStruct_Protocol_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::S_LOGIN, _impl_.myplayers_),
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_Protocol_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\'\n\tmyPlayers\030\002 \003(\0132\024.Protocol.PlayerInfo"
  ...
  "VE\022\"\n\004info\030\001 \001(\0132\024.Protocol.PlayerInfo\"\016"
  "\n\014C_LEAVE_GAME\"\016\n\014S_LEAVE_GAME\"0\n\007S_SPAW"
  "N\022%\n\007players\030\001 \003(\0132\024.Protocol.PlayerInfo"
  "\"\036\n\tS_DESPAWN\022\021\n\tplayerIDs\030\001 \003(\004b\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_Protocol_2eproto = {
    false, false, 440, descriptor_table_protodef_Protocol_2eproto,
    "Protocol.proto",
...
void S_LOGIN::clear_myplayers() {
  _impl_.myplayers_.Clear();
}
...
S_LOGIN::S_LOGIN(const S_LOGIN& from)
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.myplayers_){from._impl_.myplayers_}
...
inline void S_LOGIN::SharedCtor(
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.myplayers_){arena}
    , decltype(_impl_.success_){false}
    , /*decltype(_impl_._cached_size_)*/{}
  };
}
...
inline void S_LOGIN::SharedDtor() {
  ...
  _impl_.myplayers_.~RepeatedPtrField();
}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_myplayers(), ptr);
            CHK_(ptr);
...
uint8_t* S_LOGIN::_InternalSerialize(
  ...
  // repeated .Protocol.PlayerInfo myPlayers = 2;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_myplayers_size()); i < n; i++) {
    const auto& repfield = this->_internal_myplayers(i);
...
// @@protoc_insertion_point(message_byte_size_start:Protocol.S_LOGIN)
  ...
  // repeated .Protocol.PlayerInfo myPlayers = 2;
  total_size += 1UL * this->_internal_myplayers_size();
  for (const auto& msg : this->_impl_.myplayers_) {
    total_size +=
...
void S_LOGIN::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.myplayers_.MergeFrom(from._impl_.myplayers_);
...
void S_LOGIN::InternalSwap(S_LOGIN* other) {
  ...
  _impl_.myplayers_.InternalSwap(&other->_impl_.myplayers_);
...
class S_ENTER_GAME::_Internal {
 public:
  static const ::Protocol::PlayerInfo& info(const S_ENTER_GAME* msg);
};
